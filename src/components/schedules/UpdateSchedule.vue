            ...
            <div class="container row">
                <div class="row">
                    ...
                    <form id="scheduleForm" class="col-6">
                        ...
                        <input type="button" value="Update Schedule" class="btn btn-primary float-end"
                            @click="sendForm()">
                    </form>
                </div>
            </div>
...
export default {
    ...
    methods: {
        fillTable(exercise) {
            ...
            row.id = "row" + exercise.exerciseId;
            const cellExercise = document.createElement("td");
            cellExercise.textContent = exercise.name;
            const cellSets = document.createElement("td");
            const setsInput = document.createElement("input");
            setsInput.id = "sets" + exercise.exerciseId;
        ...
        sendForm() {
            ...
            axios
                .put("/schedules/updateschedule", schedule)
                .then((response) => {
